-- metric_id: click_to_invite_sucess
-- metric_name: 点击->邀请成功漏斗
-- card_name: Click to invite sucess
-- card_id: 3213
...
ifnull(invite_success_uv,0) as numerator,
ifnull(click_link_pv,0) as denominator,
COALESCE(invite_success_uv/ NULLIF(click_link_pv, 0), 0)  as value
from
(select 
