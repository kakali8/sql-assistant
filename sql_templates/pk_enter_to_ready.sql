-- metric_id: pk_enter_to_ready
-- metric_name: PK准备率
-- card_name: PK enter to ready
-- card_id: 3232
-- dashboard: L2 (id=522)
-- business_domain: PK
-- owner: ops, product
-- definition: PK 成功进入 → 准备
-- description: 关注重点: 准备率
...
SELECT
    ...
    countDistinctIf((m2.pk_id, m2.acc_pid), (m2.last_status IN ('ready','fighting','gameover'))
        OR (m2.stage_final_status IN ('ready','fighting','gameover'))) AS numerator,
