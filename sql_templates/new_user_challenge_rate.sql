-- metric_id: new_user_challenge_rate
-- metric_name: 新用户KiX Challenge参与率
-- card_name: New User Challenge Rate
-- card_id: 3279
-- dashboard: L2 (id=522)
-- business_domain: Daily Challenge
-- owner: marketing
-- definition: 新用户第一天Challenge参与率
-- evaluation: higher_is_better
-- related_metrics: new_user_kix_challenge_book_rate
