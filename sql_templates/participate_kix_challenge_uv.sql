-- metric_id: participate_kix_challenge_uv
-- metric_name: 赛事参赛人数趋势
-- card_name: Participate kix challenge uv
-- card_id: 3197
-- dashboard: CEO (id=518)
-- business_domain: Daily Challenge
-- owner: product, ops, marketing
-- definition: 实际参赛用户数
-- description: 赛事参赛人数趋势
-- evaluation: higher_is_better
-- related_metrics: new_user_challenge_rate, book_kix_challenge_uv, from_waiting_to_start_match, finish_kix_challenge_rate
