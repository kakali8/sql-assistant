-- metric_id: auto_reminder_show
-- metric_name: 参赛提醒卡片展示率
-- card_name: Auto reminder show
-- card_id: 3361
-- dashboard: L2 (id=522)
-- business_domain: Daily Challenge
-- owner: ceo, marketing, product, ops
-- definition: 展示用户/book用户
-- description: 展示率
...
SELECT
    ...
    countDistinctIf(b.acc_uid, ar.type = 1) AS numerator,
    -- countDistinctIf(b.acc_uid, ar.type = 2) AS remind_click_uv,
