-- metric_id: kix_challenge_reward_value
-- metric_name: KiX challleng兑换金额
-- card_name: KiX Challenge reward value
-- card_id: 3204
-- dashboard: CEO (id=518)
-- business_domain: Daily Challenge
-- owner: ops, marketing
-- definition: 每日KiX challeng兑奖金额
-- description: 兑奖金额
