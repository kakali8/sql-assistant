-- metric_id: dnu_avg_play_minute_d0
-- metric_name: 新用户第一天平均玩游戏时长
-- card_name: dnu_avg_play_minute_d0
-- card_id: 3277
-- dashboard: CEO (id=518)
-- business_domain: PK
-- owner: product
-- definition: 新用户第一天平均玩游戏时长
...
SELECT
  ...
  -- count(distinct d0.pid) as dnu_in_pk,
  -- COALESCE(count(distinct d0.pid) / NULLIF(count(distinct nu.pid), 0), 0) as new_user_day0_play_rate,
