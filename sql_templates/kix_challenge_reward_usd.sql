-- metric_id: kix_challenge_reward_usd
-- metric_name: KiX challenge奖励金额
-- card_name: KiX Challenge reward usd
-- card_id: 3202
-- dashboard: CEO (id=518)
-- business_domain: Daily Challenge
-- owner: ops, marketing
-- definition: 每日KiX challenge奖励金额
